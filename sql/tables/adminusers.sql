...
insert into adminusers (id, username, name, password, enabled) values (7, 'dave', 'Dave', 'ae0ce887676b6d4fa6db438c94daca83', true);
insert into adminusers (id, username, name, password, enabled) values (8, 'steven', 'Steven', '57f417b438b12da673e661e998e5bb92', true);
insert into adminusers (id, username, name, password, enabled) values (9, 'dburka', 'Daniel', '6aecdfe8b004d1e8cb1e42c4414687a9', true);
insert into adminusers (id, username, name, password, enabled) values (10, 'dennis', 'Dennis', 'ae0ce887676b6d4fa6db438c94daca83', true);
insert into adminusers (id, username, name, password, enabled) values (11, 'kelly', 'Kelly', 'ae0ce887676b6d4fa6db438c94daca83', true);
